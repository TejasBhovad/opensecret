...
export const blockedRelationships = pgTable('blocked_relationships', {
  ...
  uniqueIdx: uniqueIndex('blocked_relationships_unique_idx')
    .on(table.user_id, table.pod_id)
}));
...
export const archivedPods = pgTable('archived_pods', {
  ...
  uniqueIdx: uniqueIndex('archived_pods_unique_idx')
    .on(table.user_id, table.pod_id)
}));
...
export const bookmarks = pgTable('bookmarks', {
  ...
  uniqueIdx: uniqueIndex('bookmarks_unique_idx')
    .on(table.user_id, table.pod_id)
}));
...
export const podCreators = pgTable('pod_creators', {
  ...
  uniqueIdx: uniqueIndex('pod_creators_unique_idx')
    .on(table.user_id, table.pod_id)
}));
...
export const timeCapsules = pgTable('time_capsules', {
  ...
  uniqueIdx: uniqueIndex('time_capsules_unique_idx')
    .on(table.user_id, table.pod_id)
}));
